...
func (c *chatServiceClient) GetChat(ctx context.Context, in *ChatRequest, opts ...grpc.CallOption) (*ChatResponse, error) {
...
func (UnimplementedChatServiceServer) GetChat(context.Context, *ChatRequest) (*ChatResponse, error) {
